...
from src.utils.lda2vec_loss import loss, topic_embedding
...
def train(data, unigram_distribution, word_vectors, write_path,
    ...
    if doc_weights_init is not None:
        model.doc_weights.weight.data = torch.FloatTensor(doc_weights_init)
    ...
    try:
        for epoch in range(1, n_epochs + 1):
            ...
            for batch in tqdm(iterator):
                ...
                noise = sigma*Variable(torch.randn(doc_weights_shape))
